...
@Schema(description = "펫 수정 요청 (multipart data part JSON, 모든 필드 선택 — 보낸 필드만 반영)")
public record PetUpdateReq(
        @Schema(description = "반려동물 종류 (DOG/CAT 등)", example = "DOG")
        PetType petType,
