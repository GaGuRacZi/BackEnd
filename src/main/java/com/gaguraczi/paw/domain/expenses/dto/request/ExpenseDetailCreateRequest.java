...
public record ExpenseDetailCreateRequest(
        ...
        @Schema(description = "내역명 (최대 255자)", example = "유선종양 수술", requiredMode = Schema.RequiredMode.REQUIRED)
        @NotBlank(message = "내역명은 필수입니다.")
        @Size(max = 255, message = "내역명은 255자 이하여야 합니다.")
        String expenseDetailName,

        @Schema(description = "비용(원)", example = "42000", requiredMode = Schema.RequiredMode.REQUIRED)
